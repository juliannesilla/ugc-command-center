// Phase A.14l Wave 1 · A14L-L3-F /templates polish (additive — coming-soon stub)
    ...
    <>
      ...
      <div className="px-7 md:px-12 -mt-8 pb-20">
        <div className="rise rise-2 group relative overflow-hidden rounded-3xl bg-white p-10 shadow-card ring-1 ring-cloud-100 max-w-3xl transition-all duration-300 hover:shadow-glow hover:ring-cloud-200 hover:-translate-y-0.5">
          <span
            aria-hidden
            className="pointer-events-none absolute -top-16 -right-16 h-48 w-48 rounded-full bg-gradient-to-br from-iris-200/40 via-cloud-200/30 to-transparent blur-2xl transition-opacity duration-500 group-hover:opacity-80 opacity-60"
          />
